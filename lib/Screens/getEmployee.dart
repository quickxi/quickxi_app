...
import 'package:quickxi_app/Model/EmployeeModel.dart';
import 'package:quickxi_app/Screens/deleteEmployee.dart';
...
class DetailPage extends StatelessWidget {
  ...
  deleteEmployee1(EmployeeModel)async{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(employee.firstName ?? ''),actions: <Widget>[
      ...
      body: Container(child: Text('FirstName' + ' ' + (employee.firstName ?? '') + ' ' + 'LastName' + (employee.lastName ?? '')),
      ),
